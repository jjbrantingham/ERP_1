...
public class ReportExportService : IReportExportService
{
    public async Task<byte[]> ExportReportAsync<T>(T data, ExportFormat format, string reportTitle, CancellationToken cancellationToken = default)
    {
        ...
        {
            ExportFormat.CSV => await ExportToCsvAsync(data is IEnumerable<object> enumerable ? enumerable : new[] { data }, true, cancellationToken),
            ExportFormat.Excel => await ExportToExcelAsync(data is IEnumerable<object> enumerable ? enumerable : new[] { data }, reportTitle, true, cancellationToken),
